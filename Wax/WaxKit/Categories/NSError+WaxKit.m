...
//            recoverySuggestion = NSLocalizedString(@"com.wax.api.suggestion=1010", @"Sorry, we encountered an error creating your account. Please try again, and if the problem persists please email support@wax.li");
        }break;
        case 9002:{
